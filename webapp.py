...
from config import OUTPUTS_DIR, PROJECT_ROOT, get_default_url, init_env, load_scenario
from runner import PreparedRun, prepare_run, execute_prepared_run
...
class AppHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if path.startswith("/web/"):
            self._serve_static(WEB_DIR, path[len("/web/"):])
            return
